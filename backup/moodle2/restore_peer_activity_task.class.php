...
require_once($CFG->dirroot . '/mod/peer/backup/moodle2/restore_peer_stepslib.php');

/**
 * Restore task for the peer activity module
 *
...
class restore_peer_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('NEWMODULEVIEWBYID', '/mod/peer/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('NEWMODULEINDEX', '/mod/peer/index.php?id=$1', 'course');
